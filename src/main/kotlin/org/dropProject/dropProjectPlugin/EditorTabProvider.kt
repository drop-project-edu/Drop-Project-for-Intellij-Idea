...
class EditorTabProvider : FileEditorProvider, DumbAware {
    override fun accept(@NotNull project: Project, @NotNull file: VirtualFile): Boolean {
        return file is org.dropProject.dropProjectPlugin.VirtualFile
    }

    override fun createEditor(@NotNull project: Project, @NotNull file: VirtualFile): FileEditor {
        return PanelEditor(file as org.dropProject.dropProjectPlugin.VirtualFile)
    }
...
class PanelEditor(private val virtualFile: org.dropProject.dropProjectPlugin.VirtualFile) :
